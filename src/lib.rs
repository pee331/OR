...
#[derive(Debug)]
pub struct ORMMapperProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ORMMapperProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ORMMapper processing");
    
    let mut processor = ORMMapperProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ORMMapperProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ORMMapperProcessor::new(false);
